# Vendored from github.com/microsoft/satclip (MIT License)
# Import paths adjusted for vendored use under src/models/satclip/
# Removed einops dependency (replaced with torch.unsqueeze / reshape)
...
class SirenNet(nn.Module):
    ...
    def forward(self, x, mods = None):
        ...
        for layer, mod in zip(self.layers, mods):
            ...
            if exists(mod):
                x *= mod.unsqueeze(0)  # equivalent to rearrange(mod, 'd -> () d')
